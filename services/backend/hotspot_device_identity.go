...
// arquivo do projeto.
func registerHotspotDeviceIdentityRoute(mux *http.ServeMux, admin *administrator, db *sql.DB) {
	mux.HandleFunc("PATCH /api/hotspot/devices/{mac}/identity", requireSession(admin, func(w http.ResponseWriter, r *http.Request) {
