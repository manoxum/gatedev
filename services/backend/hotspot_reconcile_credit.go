...
func reconcileDeviceCredit(ctx context.Context, db *sql.DB, worker *workerClient, creditTrace *creditTraceClient, mac, ip string, effectiveType limitType, totalBytes int64) error {
