...
// ciclo inteiro.
func startHotspotUsageSamplingLoop(db *sql.DB, worker *workerClient, creditTrace *creditTraceClient, speedHistory *deviceSpeedHistoryStore, interval time.Duration) {
...
func sampleHotspotUsageOnce(ctx context.Context, db *sql.DB, worker *workerClient, creditTrace *creditTraceClient, speedHistory *deviceSpeedHistoryStore) {
	var status struct {
...
func reconcileGlobalUsage(db *sql.DB, worker *workerClient, speedHistory *deviceSpeedHistoryStore) error {
	ctx := context.Background()
...
func reconcileDeviceUsage(ctx context.Context, db *sql.DB, worker *workerClient, creditTrace *creditTraceClient, speedHistory *deviceSpeedHistoryStore, mac, ip string) error {
