...
func RegisterHotspotCreditHistoryRoutes(mux *http.ServeMux, admin *auth.Administrator, db *sql.DB) {
	mux.HandleFunc("GET /api/hotspot/devices/{mac}/credit/history", auth.RequireSession(admin, func(w http.ResponseWriter, r *http.Request) {
