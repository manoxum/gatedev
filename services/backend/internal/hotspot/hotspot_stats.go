...
func RegisterHotspotStatsRoutes(mux *http.ServeMux, admin *auth.Administrator, db *sql.DB, worker *workerapi.Client) {
	mux.HandleFunc("GET /api/hotspot/devices/{mac}/stats", auth.RequireSession(admin, func(w http.ResponseWriter, r *http.Request) {
	...
	mux.HandleFunc("GET /api/hotspot/clients/stats", auth.RequireSession(admin, func(w http.ResponseWriter, r *http.Request) {
	...
	mux.HandleFunc("GET /api/hotspot/stats/global", auth.RequireSession(admin, func(w http.ResponseWriter, r *http.Request) {
...
func globalLiveStats(ctx context.Context, worker *workerapi.Client) (hotspotDeviceStatsResponse, error) {
...
func trackedDeviceRate(ctx context.Context, db *sql.DB, worker *workerapi.Client, iface, mac, ip string) (hotspotDeviceStatsResponse, error) {
