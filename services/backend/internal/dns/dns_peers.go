...
func RegisterDNSPeerRoutes(mux *http.ServeMux, admin *auth.Administrator, db *sql.DB, worker *workerapi.Client, audit *audit.Client) {
	mux.HandleFunc("GET /api/dns/peers", auth.RequireSession(admin, func(w http.ResponseWriter, r *http.Request) {
