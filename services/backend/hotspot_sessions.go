...
func registerHotspotSessionRoutes(mux *http.ServeMux, admin *administrator, db *sql.DB, creditTrace *creditTraceClient) {
	mux.HandleFunc("GET /api/hotspot/devices/{mac}/sessions/{id}/consumption", requireSession(admin, func(w http.ResponseWriter, r *http.Request) {
