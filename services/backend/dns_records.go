...
func registerDNSRecordRoutes(mux *http.ServeMux, admin *administrator, db *sql.DB, audit *auditClient) {
	mux.HandleFunc("GET /api/dns/records", requireSession(admin, func(w http.ResponseWriter, r *http.Request) {
	...
	mux.HandleFunc("POST /api/dns/records", requireSession(admin, func(w http.ResponseWriter, r *http.Request) {
		var req struct {
			Hostname string `json:"hostname"`
		}
	...
	mux.HandleFunc("DELETE /api/dns/records", requireSession(admin, func(w http.ResponseWriter, r *http.Request) {
	...
	mux.HandleFunc("DELETE /api/dns/records/{hostname}", requireSession(admin, func(w http.ResponseWriter, r *http.Request) {
