// Package netdetect descobre os IPs de rede do host relevantes ao
// dns-provider (gateways das bridges Docker, IPs de LAN/peer) e espera
// esses IPs existirem antes de abrir os sockets DNS.
package netdetect
